      ...
      <nav className="fixed w-full top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200 transition-all" aria-label="Hauptnavigation">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <details className="md:hidden group">
            <summary
              className="list-none text-slate-900 p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-900 rounded-sm cursor-pointer [&::-webkit-details-marker]:hidden"
            ...
            <div className="absolute left-0 right-0 top-20 bg-white border-b border-slate-200 overflow-hidden shadow-sm">
              <div className="px-6 py-4 flex flex-col gap-4 text-center">
                ...
                <a href="/#kontakt" className="bg-blue-900 text-white px-5 py-3 rounded-sm w-full hover:bg-blue-800 transition-colors">
                  Gespräch vereinbaren
                </a>
              </div>
            </div>
