...
4. Soweit der Auftraggeber den Einsatz bestimmter Dienste, Integrationen, Provider oder technischer Architekturen vorgibt, freigibt oder wünscht, erfolgt deren Nutzung auf Grundlage dieser projektbezogenen Entscheidung des Auftraggebers. Der Auftragnehmer weist auf erkennbare datenschutzrechtliche oder geheimnisschutzrelevante Risiken im Rahmen seiner technischen Kenntnis hin, übernimmt jedoch keine eigenständige rechtliche Gesamtbewertung des vom Auftraggeber gewünschten Setups.
...
Sicherstellung des technischen Betriebs, der Funktionsfähigkeit, Sicherheit, Aktualität und Weiterentwicklung der Webpräsenz und der daran angebundenen Systeme.

### 3. Verarbeitungsvorgänge

- Zugriff auf Hosting-, DNS-, CDN-, Worker-, Pages-, CMS-, Mail- oder Repository-Umgebungen
- technische Analyse von Logdateien und Fehlermeldungen
- Deployment, Wartung, Versionsverwaltung und Wiederherstellung
- Anpassung und Pflege von Formularen, Integrationen und Inhalten
- Administration von Nutzer-, Rollen- und Zugriffsrechten
...
- IP-Adressen und Logdaten
- Account- und Administrationsdaten
- besondere Kategorien personenbezogener Daten
- sonstige vertrauliche oder geheimnisschutzrelevante Informationen

### 5. Kategorien betroffener Personen

- Websitebesucher
- Interessenten, Kunden, Mandanten, Patienten, Klienten oder sonstige Anfragende
- Beschäftigte und sonstige Nutzerkonten des Auftraggebers
...
- Zutrittskontrolle zu den Räumlichkeiten, in denen personenbezogene Daten oder sonstige geschützte Informationen verarbeitet werden, durch abschließbare Zugänge und Ausschluss unbefugter Dritter
- Zugriff auf Endgeräte nur mittels starker Passwörter, PIN oder biometrischer Authentifizierung
- Automatische Bildschirmsperre bei Inaktivität
- Clear-Screen-Policy und Schutz vor Einsichtnahme durch Dritte im Arbeitsumfeld
- Rollen- und berechtigungsbezogene Zugriffsbeschränkung auf Kundenkonten und Projektsysteme
- Nutzung personalisierter Benutzerkonten
- Einsatz von Mehr-Faktor-Authentifizierung, soweit vom eingesetzten Dienst unterstützt und für das betroffene System administrativ relevant
- Sichere Verwaltung von Zugangsdaten und Tokens; keine unverschlüsselte dauerhafte Ablage in allgemein zugänglichen Dateien
- Vertraulichkeitsverpflichtung der zur Verarbeitung berechtigten Personen
- zusätzliche Unterweisung eingesetzter Personen über die besondere Sensibilität geheimnisschutzrelevanter Informationen bei entsprechenden Projekten

### 2. Integrität

- Datenübertragung ausschließlich über verschlüsselte Verbindungen (TLS/HTTPS, SSH oder funktional gleichwertig)
- Schutz vor unbefugter Veränderung durch Berechtigungs- und Rollenmanagement
- Nachvollziehbarkeit wesentlicher Änderungen über Versionsverwaltung, Deployment-Historien oder Systemprotokolle, soweit technisch verfügbar
- Trennung von Umgebungen und Projekten verschiedener Auftraggeber durch separate Repositories, Deployments, Konten oder logisch getrennte Bereiche

### 3. Verfügbarkeit und Belastbarkeit

- Nutzung etablierter Cloud- und Hosting-Dienste mit georedundanter oder hochverfügbarer Infrastruktur, soweit Bestandteil des jeweiligen Kundensetups
- Redundante Verfügbarkeit des Quellcodes über Versionsverwaltung
- Geordnete Wiederherstellbarkeit über Repository- und Deployment-Stand
- Regelmäßige Einspielung sicherheitsrelevanter Updates für lokal eingesetzte Systeme und Software in angemessenem zeitlichen Rahmen

### 4. Datenminimierung und Zugriffsbeschränkung

- Zugriff auf personenbezogene Daten und sonstige geschützte Informationen nur, soweit dies für den jeweiligen Auftrag erforderlich ist
- Verarbeitung in Test- und Supportfällen nach Möglichkeit mit minimierten Datensätzen
- Keine über den Auftrag hinausgehende Nutzung, Auswertung oder Speicherung personenbezogener Daten

### 5. Incident-Management

- Einsatz aktueller Betriebssysteme und Sicherheitsupdates auf den verwendeten Endgeräten
- Einsatz marktüblicher Schutzmaßnahmen gegen Schadsoftware und unbefugte Zugriffe
- Verfahren zur Erkennung, Bearbeitung und Meldung von Sicherheitsvorfällen in angemessenem Umfang
- Unverzügliche Information des Auftraggebers bei bekannt gewordenen Datenschutzverletzungen oder sonstigen geheimnisschutzrelevanten Vorfällen mit Bezug zum Auftrag

### 6. Löschung und Aufbewahrung

- Löschung oder Rückgabe personenbezogener Daten nach Weisung des Auftraggebers oder nach Vertragsende, soweit keine gesetzliche Aufbewahrungspflicht besteht
- Beschränkung verbleibender Kopien auf technisch unvermeidbare oder rechtlich erforderliche Restbestände

### 7. Überprüfung und Evaluierung

- Regelmäßige Überprüfung des Berechtigungsniveaus und der genutzten Accounts
- Anlassbezogene Überprüfung der Sicherheitsmaßnahmen bei Änderungen der eingesetzten Systeme oder Dienste
- Dokumentation wesentlicher sicherheitsrelevanter Konfigurationen und Verantwortlichkeiten in angemessenem Umfang
...
| Dienst | Anbieter | Zweck | Möglicher Drittlandbezug | Bemerkung |
|---|---|---|---|---|
| Cloudflare | Cloudflare, Inc., USA | DNS, CDN, Hosting, Worker-/Pages-Betrieb, Security- und Performance-Funktionen | ja | nur soweit im Projekt genutzt; DPA und Subprocessor-Liste des Anbieters beachten; bei erhöhtem Schutzbedarf projektbezogen gesondert prüfen, insbesondere hinsichtlich Art und Umfang der über Cloudflare laufenden Inhalte |
| GitHub | GitHub, Inc., USA | Versionsverwaltung, Repository-Hosting, Deployment-nahe Entwicklungsprozesse | ja | nur soweit im Projekt genutzt; Vertrags- und DPA-Lage abhängig vom konkret genutzten GitHub-Produkt prüfen; bei erhöhtem Schutzbedarf projektbezogen gesondert prüfen |
| Resend | Resend, Inc., USA | Versand transaktionaler E-Mails / Formularweiterleitung | ja | nur soweit im Projekt genutzt; bei erhöhtem Schutzbedarf projektbezogen gesondert prüfen oder vermeiden, insbesondere bei inhaltlich sensiblen Formularübermittlungen |
| Keystatic / GitHub Mode | je nach Setup, regelmäßig GitHub | Content-Verwaltung innerhalb des Repositories | möglich | nur soweit im Projekt genutzt; im GitHub-Mode ist regelmäßig GitHub der technisch maßgebliche Dienst; bei erhöhtem Schutzbedarf projektbezogen gesondert prüfen |
